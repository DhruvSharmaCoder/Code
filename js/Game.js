class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 259, y: height - 899, image: obstacle2Image },
      { x: width / 2 + 359, y: height - 1799, image: obstacle2Image },
      { x: width / 2 - 289, y: height - 2999, image: obstacle2Image },
     
      { x: width / 2 - 259, y: height - 3999, image: obstacle2Image },
      { x: width / 2 + 199, y: height - 4999, image: obstacle2Image },
      { x: width / 2 - 199, y: height - 4999, image: obstacle2Image },
      { x: width / 2 + 309, y: height - 4999, image: obstacle2Image },
    ];
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      if (player.positionY > finishLine) {
        gameState = 3;
        image(track2, 0, -height * 5, width, height * 6);
        Player.updateLevels(player.level);
        player.update();
        this.levels();
      }
